  ...
  return (
    <div className="bg-black text-white py-12 px-6 md:px-16 flex flex-col md:flex-row items-center md:items-start gap-8">
      ...
      <div className="flex flex-col items-start gap-6 md:w-3/5">
        ...
        <div className="flex flex-col gap-3"> {/* Reduced gap between buttons */}
          <button className="bg-orange-500 hover:bg-orange-600 text-white rounded-lg  py-2 px-6 text-lg rounded-lg">
            Shiboshis Collection
          </button>
          <button className="bg-blue-500 rounded-lg hover:bg-blue-600 text-white py-2 px-6 text-sm rounded-lg">
            Buy on OpenSea
          </button>
        </div>
      </div>
